...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<simple_form>.freeze, [">= 5.0.1".freeze])
  s.add_runtime_dependency(%q<activerecord>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<ransack>.freeze, [">= 2.3.2".freeze])
  ...
  s.add_development_dependency(%q<caxlsx_rails>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<will_paginate>.freeze, [">= 3.1.0".freeze])
